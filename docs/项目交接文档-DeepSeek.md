...
>
> **提交锚点**：代码提交从 `f5af0d7` 一路到 **`4ad3492`**（P1-5-4；P1-5-3 是 `b0400fe`、P1-5-2 是 `730268d`、P1-5-1 是 `39f1fe2`），其后是文档提交 `c07cba2`（勾选与完成记录）；**准确 HEAD 请直接跑 `git log --oneline -5`（工作区应当是干净的）**，写死哈希会立刻过时。每一项的提交号都写在 `docs/项目补充优化.md` 的完成记录与 3.3 节里。
>
> **文档地图（新会话先看这张表）**：
>
> | 文档 | 作用 |
